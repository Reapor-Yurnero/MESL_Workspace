...
iptables -I INPUT -i docker1 -p udp --match multiport --dport 49152:65535 -j ACCEPT
iptables -I INPUT -i docker1 -p tcp --match multiport --dport 49152:65535 -j ACCEPT
